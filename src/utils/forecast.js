...
const forecast = (latitude, longitutde, callback) => {
    const url2 = "http://api.openweathermap.org/data/2.5/weather?lat=" + encodeURIComponent(latitude) +"&lon="+ encodeURIComponent(longitutde) + "&appid=04ddc42ea251e397d88a312713207d15&units=metric"
